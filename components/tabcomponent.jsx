...
const TabComponent = () => {
  ...
  const [fullName, setFullName] = useState('Tanmay');
      ...
      case 'personal':
        return (
          <div className="content">
            ...
            <div className="form-row">
              <div className="form-group">
                <input type="tel" placeholder="Contact" value={contact} onChange={handleContactChange} />
              </div>
              <div className="form-group">
            ...
            <div className="form-group full-width">
              <input type="text" placeholder="Current Address" value={currentAddress} onChange={(e) => setCurrentAddress(e.target.value)} />
            </div>
          </div>
        );
      case 'educational':
    ...
    <div className="maindiv" >
      ...
      <div className="tab-container">
        <div className="profile">
          <img src="user.jpg" alt="Profile" className="profile-img" />
          <h3>Tanmay Gupta</h3>
        ...
        <div className="content-wrapper">
          <div className="tabs">
            ...
            <div className={`tab ${activeTab === 'educational' ? 'active' : ''}`} onClick={() => setActiveTab('educational')}>
              Educational Background
            </div>
            <div className={`tab ${activeTab === 'professional' ? 'active' : ''}`} onClick={() => setActiveTab('professional')}>
